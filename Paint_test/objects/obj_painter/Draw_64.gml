...
if(multiplayer){
			...
			//draw_text_color(16,48,"stroke_full_withdraw_rec: "+string(stroke_full_withdraw_rec_arr), c_black, c_black, c_black, c_black, 1);
			...
			//			draw_text_color(16+i*128+k*32,108+j*16,string(stroke_all_arr[i][k][j]), c_black, c_black, c_black, c_black, 1);
			//		}
			//	}
			//}
			
	//for(var i=0; i<array_length(stroke_all_arr); i++){draw_text_color(16+i*72,24,string(stroke_all_arr[i][0][0]), c_black, c_black, c_black, c_black, 1);}
